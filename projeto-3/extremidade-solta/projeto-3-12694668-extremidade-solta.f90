PROGRAM tarefa1
  ...
  REAL(8)   , ALLOCATABLE  :: Yn(:,:), Psi(:), xaxis(:)
  ...
  !! ITEM b
  ! x0 = L/4d0
  ! OPEN(UNIT=1, FILE="item-b-espectro-de-potencia-ponta-solta.out", STATUS="UNKNOWN")
  
  !! ITEM c
  ! x0 = L/3d0
  ! OPEN(UNIT=1, FILE="item-c-espectro-de-potencia-ponta-solta.out", STATUS="UNKNOWN")

  !! ITEM d
  ! x0 = L/20d0
  ! OPEN(UNIT=1, FILE="item-d-espectro-de-potencia-ponta-solta.out", STATUS="UNKNOWN")
