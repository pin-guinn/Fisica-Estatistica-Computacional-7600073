...
PROGRAM tarefa3
  ...
  !! Séries (e) e (f) da tarefa 3 (atual)
  CALL GerarSerie(200, 0.04d0, 2d0, 4d0, 4d0*PI, 1.4d0*PI)
  ! CALL GerarSerie(200, 0.04d0, 2d0, 4d0, 4.2d0*PI, 1.4d0*PI)


  !! Séries (a) e (c), da tarefa 1
