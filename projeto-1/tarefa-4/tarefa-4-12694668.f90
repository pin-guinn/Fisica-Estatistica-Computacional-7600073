...
PROGRAM tarefa4
  ...
  CALL GerarSerie(200, 0.04d0, 2d0, 4d0, 4d0*PI, 2.5d0*PI) !! Gerar serie em 'data.in'
  CALL Fourier(200, 0.04d0) ! Transformar séries 'data.in' em série espectral 'data.out'
  CALL InvFourier(200, 0.04d0) ! Recuperar série temporal em 'datainv.out' através de 'data.out'
END PROGRAM
